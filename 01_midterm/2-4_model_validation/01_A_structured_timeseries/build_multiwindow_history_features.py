...
summary = {
    ...
    "feature_period": "2016-01~2022-08",
    "rows": len(output),
...
output.to_parquet(BASE / "multiwindow_history_features_pretest.parquet", index=False)
spec.to_csv(BASE / "multiwindow_history_feature_spec.csv", index=False, encoding="utf-8-sig")
(BASE / "multiwindow_history_validation.json").write_text(
