...
OUTPUT_PANEL = OUT / "combined_train_valid_c8_intensity.parquet"
METRICS_PATH = OUT / "intensity_c8_candidate_metrics.csv"
PREDICTIONS_PATH = OUT / "intensity_c8_candidate_predictions.parquet"
IMPORTANCE_PATH = OUT / "intensity_c8_candidate_importance.csv"
SETS_PATH = OUT / "intensity_c8_model_feature_sets.json"
SUMMARY_PATH = OUT / "intensity_c8_experiment_summary.json"
MODEL_DIR = OUT / "models_intensity_c8"
...
baseline = base_sets.get("C8_S45_plus_B8")
...
feature_sets = {
    "I0_reproduce_C8_S45_plus_B8": unique_keep_order(baseline),
...
baseline_pr = float(
    metrics.loc[metrics["model_name"].eq("I0_reproduce_C8_S45_plus_B8"), "pr_auc"].iloc[0]
)
...
SUMMARY_PATH.write_text(json.dumps({
    ...
    "baseline_model": "I0_reproduce_C8_S45_plus_B8",
